      ...
      body: Padding(
        ...
        child: Stack(
          children:[
            ListView(
              children: [
                Text('Customer Details',style: TextStyle(fontSize: 20,fontFamily: 'Poppins',fontWeight: FontWeight.w600),),
                SizedBox(height: 10,),
                ...
                Row(
                  ...
                  children: [
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Zack Snyder',style: TextStyle(fontSize: 20,fontFamily: 'Poppins',fontWeight: FontWeight.w600),),
